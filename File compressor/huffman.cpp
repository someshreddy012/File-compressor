...
int main()
{
    // Create an instance of the 'huffman' class and perform compression or decompression
    // based on your requirements

    // Example usage:
    huffman compressor("F5.pdf", "compressed.huf");
    compressor.compress();

    huffman decompressor("compressed.huf", "output.txt");
